...
def search_record():
    student_list.delete(0, END)
    for row in db.search(en_date.get(), en_sname.get(), en_grade.get(), en_class.get(), en_pname.get(), en_psign.get(),
...
def add_record():
    try:
        if en_sname.get():
            db.insert(en_date.get(), en_sname.get(), en_grade.get(), en_class.get(), en_pname.get(), en_psign.get(),
                      en_cin.get(), en_ccn.get())
            student_list.delete(0, END)
...
def update_record():
    db.update(selected_content[0], en_date.get(), en_sname.get(), en_grade.get(), en_class.get(), en_pname.get(),
              en_psign.get(), en_cin.get(), en_ccn.get())
    view_all()
