...
# URL mask
# https://www.kayak.com/flights/RIC-LAS/2022-04-16/2022-04-23?sort=bestflight_a
...
class Flight_Bot:
    ...
    def start_kayak(self, city_from, city_to, date_start, date_end):
        ...
        try:
            ...
            driver.find_elements_by_xpath('//button[contains(@class,"heading withBorder Button-No-Standard-Style")]')[
                1].click()
            # Let's also get the lowest prices from the matrix on top
            matrix = driver.find_elements_by_xpath('//*[contains(@id,"FlexMatrixCell")]')
            matrix_prices = [price.text.replace('$', '') for price in matrix]
